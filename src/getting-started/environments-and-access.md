...
| Interface Mechanism 1 PFS Auth (IM1 Auth) | Provides a means of authenticating a user (using an NHS login token) and establishing an IM1 session to access Patient-Facing Services (PFS). | [IM1 Auth API Catalogue page](https://digital.nhs.uk/developer/api-catalogue/im1-pfs-auth-api)          |
