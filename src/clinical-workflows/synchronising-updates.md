...
<div class="nhsuk-inset-text">
  <p>It's important to note that you may hold a proxy role where the subject is not a patient under the care of the organisation. For example you hold a list of proxy roles for the proxy at the *proxy's* GP practice to support GP's viewing who they are a proxy for and the patient is registered at another GP practice. In this scenario the proxy is the patient under the care of the GP, but there are still relevant updates regarding roles with a subject registered elsewhere. In which case, whilst the patient (subject) may not be under the care of the receiving system, there will still be a relevant proxy role update to apply. </p>
</div>
